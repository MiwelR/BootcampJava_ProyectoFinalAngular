...
export class TaskDetailsPageComponent implements OnInit {
  ...
  ngOnInit():void {
      ...
      this._route.queryParams.subscribe(
        (params) => {
          if(params.id || params.titulo || params.urgencia || params.responsable || params.fechaCreacion || params.fechaActualizacion ){
            this.tarea={
              id: params.id,
              ...
              fechaInicio: params.fechaCreacion,
              fechaFin: params.fechaActualizacion
            }
